...
- [x] 1.4 Logged-out visits to `/dashboard`, `/history`, `/session/<any-id>`, `/onboarding` redirect to `/auth/signin` — c9492e9
- [x] 1.5 Logged-in, no-profile visit to `/dashboard` redirects to `/onboarding` — c9492e9
- [x] 1.6 Post-onboarding revisit to `/dashboard` loads normally — c9492e9

### Phase 2: Risk #6 — AI generation safety net

#### Automated

- [x] 2.1 `npm run test` passes, including the extended `src/lib/services/plan.test.ts` — c9492e9
- [x] 2.2 `npm run lint` passes — c9492e9
- [x] 2.3 `npm run build` passes — c9492e9

#### Manual

- [x] 2.4 Normal-equipment plan generation still succeeds end-to-end in local dev — c9492e9
