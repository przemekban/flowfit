...
| --- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------- | ------------------ | ----------- | ------------------------------------------------------- |
| 1   | API + authorization safety net                  | Defend the highest-churn, highest-impact boundary: input validation and cross-user access control                        | #1, #2        | unit + integration | complete    | `context/changes/testing-api-authorization-safety-net/` |
